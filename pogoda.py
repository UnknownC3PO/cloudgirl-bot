...
if "HEROKU_BOT" in list(os.environ.keys()):
    ...
    def webhook():
        bot.remove_webhook()
        bot.set_webhook(url=f"https://cloudgirl-bot.herokuapp.com/{config.TOKEN}") # этот url нужно заменить на url вашего Хероку приложения
        return "?", 200
